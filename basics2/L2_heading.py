...
xRange = np.array([-83.6, 71.3])      #[-35.7, 115.8]                 # range must be updated for your device
yRange = np.array([-168.8,-19.845])       #[-91.8, 34.4]                 # range must be updated for your device
